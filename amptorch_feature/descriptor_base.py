...
class AMPTorchDescriptorBase(ABC):
    ...
    def __init__(self, fp_database = "./_saved_fingerprints_"):
        super().__init__()
    ...
    def prepare_fingerprints(self, trajs, elements, parallel=None, log=None, calculate_derivatives=True, save=False):
