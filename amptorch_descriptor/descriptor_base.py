...
class AMPTorchDescriptorBase(ABC):
    ...
    def prepare_fingerprints(self, trajs, parallel=False, log=None, calculate_derivatives=True, save=True):
        ...
        for traj in trajs:
            ...
            if save :
                temp_fingerprint_list, temp_fingerprint_prime_list = \
            ...
            trajs_fingerprint_list += temp_fingerprint_list
            if calculate_derivatives:
                trajs_fingerprint_prime_list += temp_fingerprint_prime_list
    ...
    def _prepare_fingerprints_single_traj(self, traj, traj_db_filename, parallel=False, log=None, calculate_derivatives=True, save=True):
        ...
        return fingerprint_list, fingerprint_prime_list
